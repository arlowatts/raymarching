...
public class Main {
	...
	public static void main(String[] args) {
		...
		Group coll = new Group(0, 0, 0, 0, 0, 0.1, 0xf4a0e6, 0.1);
		objects.add(coll);
		
		coll.add(new Sphere(2, -1, 0, 1.5, 0, 0, 0, 0));
		coll.add(new Box(1, -0.5, 0.25, 2.1, 3.14, 1.23, 0, 0, 0, 0, 0));
		
		Box box = new Box(-2.5, -3, -2.5, 0.8, 2.9, 3.4, 0.4, 0, 0, 0x7bc4a8, 0.5);
		objects.add(box);
		
		Plane plane = new Plane(0, -5, 0, 4, 4, 0, 0, 0x123456, 0.7);
		objects.add(plane);
		
		Cylinder cylinder = new Cylinder(-1, -2, 3, 1, 3, 0, 0, 0x4f7a42, 0.4);
